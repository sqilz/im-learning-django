...
class GeneralTests(TestCase):
    def test_serving_static_files(self):
        ...
        # rangoapp.jpg
        result = finders.find('images/django.png')
...
class IndexPageTests(TestCase):
    ...
    def test_index_contains_hello_message(self):
        # Check if there is the message 'appappappappappappapp Says'
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'rangoapp says', response.content)
    ...
    def test_rangoapp_picture_displayed(self):
        # Check if is there an image called 'rangoapp.jpg' on the index page
        # Chapter 4
        response = self.client.get(reverse('index'))
        self.assertIn(b'img src="/static/images/django.png', response.content)
...
class AboutPageTests(TestCase):
    ...
    def test_about_contains_create_message(self):
        ...
        self.assertIn(
            b'This tutorial has been put together by',
            response.content)
...
class Chapter4ViewTests(TestCase):
    def test_index_contains_hello_message(self):
        ...
        response = self.client.get(reverse('index'))
        self.assertIn('rangoapp says', response.content)
...
class Chapter7ViewTests(TestCase):
    ...
    pass
    # test is there a PageForm in rangoapp.forms

    # test is there a CategoryForm in rangoapp.forms
    ...
    # <a href="/rangoapp/add_category/">Add a New Category</a><br />
