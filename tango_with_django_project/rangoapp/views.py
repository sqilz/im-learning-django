...
def add_category(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # just print them t the terminal.
            print(form.errors)
...
def register(request):
    # A boolean value for tellign the template
    # whether the registration was successful
    # Set to False initially. Code changes value to
    # True when ergistration succeeds
    registered = False
    ...
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            # Update out variable to indicate that the teplate
        ...
        # Not a HTTP POST, so we render our form sing two ModelForm instances
