...
class QuestionViewTests(TestCase):
    ...
    def test_past_question(self):
        """
        Questions with a pub_date in the past are past are displayed on the
        index page.
        """
        create_question(question_text="Pasy question.", days=-30)
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.conext['latest_question_list'],
    ...
    def test_future_question(self):
        ...
        response = self.client.get(reverse('polls:index'))
        self.assertContains(response, "No plls are available.")
        self.assertQuerysetEqual(response.context['latest_question_list'], [])

    def test_future_and_pas_question(self):
        """
    ...
    def test_two_past_questions(self):
        """
        The questions index page may display multuple questions.
        """
...
class QuestionIndexDetailTest(TestCase):
    def test_detail_view_with_a_future_question(self):
        """
        The detail view of a question with apub_date in the future 
